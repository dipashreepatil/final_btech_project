...
def model(request):
   if request.is_ajax and request.method == "GET":
      ...
      table_rows_today = engine.execute("SELECT preprocessed_text FROM tweets_table WHERE date='2021-06-19' AND company='amazon'").fetchall()
      table_rows_yesterday = engine.execute("SELECT preprocessed_text FROM tweets_table WHERE date='2021-06-18' AND company='amazon'").fetchall()

      table_rows_today_news = engine.execute("SELECT preprocessed_content FROM news_table WHERE date='2021-06-19' AND company='amazon'").fetchall()
      table_rows_yesterday_news = engine.execute("SELECT preprocessed_content FROM news_table WHERE date='2021-06-18' AND company='amazon' ").fetchall()
